...
我查了 Google 官方 Gemini 模型页，当前公开文档里能明确看到的是 `gemini-2.5-pro` 等型号，没有确认到 `gemini-3.1-pro-preview` 这个公开模型名。
...
2. 如果实际调用时报 `404`、`unsupported model` 或类似错误，就回退到官方当前公开型号，例如：
